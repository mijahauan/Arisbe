...
class TransformationRuleValidator:
    ...
    def _define_validation_criteria(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "DC+": {
                ...
                "postconditions": [
                    "Two new cuts created",
                    "Subgraph enclosed",
                    "Area mapping updated",
                ],
            ...
            "INS": {
                ...
                "critical_tests": [
                    "negative_area_insertion",
                    "positive_area_rejection",
                ],
            ...
            "ERA": {
                ...
                "preconditions": [
                    "Positively-enclosed area",
                    "Subgraph exists in area",
                ],
    ...
    def validate_rule_implementation(self, rule_name: str) -> Dict[str, Any]:
        ...
        rule_tests = [
            t for t in self.test_suite.test_results if t.rule_name == rule_name
        ]
    ...
    def run_comprehensive_validation(self) -> ValidationReport:
        ...
        # Generate report
        rules_passing = sum(
            1 for v in rule_validations.values() if v.get("overall_valid", False)
        )
    ...
    def _print_validation_summary(self, report: ValidationReport):
        ...
        for rule_name, coverage in report.test_coverage.items():
            ...
            print(
                f"   {rule_name}: {coverage['actual']}/{coverage['expected']} tests ({percent:.0f}%)"
            )
...
def run_comprehensive_validation():
    ...
    report_file = validator.generate_detailed_report(
        report, "transformation_validation_report.json"
    )
...
if __name__ == "__main__":
    ...
    failing_rules = [
        name
        for name, details in report.rule_details.items()
