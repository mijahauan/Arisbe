...
class TransformationEngine:
    ...
    def apply_operation(
        self, graph: RelationalGraphWithCuts, operation: OperationRequest
    ) -> OperationResult:
        """
    ...
    def apply_operation_sequence(
        self, graph: RelationalGraphWithCuts, operations: List[OperationRequest]
    ...
    def replay_transformation_sequence(
        self, initial_graph: RelationalGraphWithCuts, sequence: CompositionSequence
    ) -> OperationResult:
        """
