...
class Chapter21DiagramPanel(QWidget):
    ...
    def create_header(self) -> QWidget:
        ...
        self.view_combo.addItems(["Overview", "Detailed", "Focused", "Structural"])
        ...
        self.format_combo.addItems(["Diagram", "EGIF", "FOPL", "CGIF", "CLIF"])
    ...
    def update_diagram_display(self):
        ...
        try:
            ...
            self.diagram_area.setStyleSheet(
                "background-color: #f0f8ff; border: 1px solid #4169e1;"
            )
    ...
    def preview_transformation(self):
        ...
        try:
            ...
            wizard = self.wizard_system.create_wizard(
                DisplayFormat.DIAGRAM, self.current_egi
            )
