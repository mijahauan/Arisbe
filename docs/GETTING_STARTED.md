...
- **Frontier:** the 3-LLM-role automated Endoporeutic Game (`src/agon_llm.py` —
  ...
  register (peel/materialize/theory-query). Also open: the universal-generalization
  rule's Dau-native scaffold
...
| **Logician** | [The central contract](LINEAR_GRAPHICAL_CORRESPONDENCE.md) | Round-trip a form → build a chain | the 3-LLM-role automated EPG; ∀-generalization scaffold |
