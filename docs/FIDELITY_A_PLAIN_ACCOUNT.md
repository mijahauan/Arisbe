# Fidelity and Doubt — A Plain Account

*What we challenged in Peirce and in the traditions that read him, how we argued
...
- *Adherence:* treating "we are converging on the truth" and "we are not" as two
  pictures, each held openly, neither stamped as fact.
- *Breaking:* a textbook that announces the "final opinion" as a destination
  science is provably approaching — a hope wearing the costume of a theorem.

*(Rigor: [FIDELITY_AND_DEPARTURES.md](FIDELITY_AND_DEPARTURES.md) §2;
[ADVERSARIAL_EXAMINATION.md](ADVERSARIAL_EXAMINATION.md) Departure I.)*
...
- *Breaking:* the famous "cat on the mat," printed right next to the theorems with
  ...
  asserting this, take it as given" from "the system delivers this as proven." Two
  utterly different credentials, erased by one undifferentiated drawing.

*(Rigor: [LEVEL_ZERO_AND_THE_REGISTERS.md](LEVEL_ZERO_AND_THE_REGISTERS.md);
[ADVERSARIAL_EXAMINATION.md](ADVERSARIAL_EXAMINATION.md) Departure II.)*

---

## Doubt 3 — Do "possible" and "necessary" need a new kind of mark?

**What stirred the doubt.** Peirce spent his last years trying to extend his
pictures to handle *possibility* and *necessity* — a project he called *Gamma*,
...
*(Rigor: [MODALITY_WITHOUT_GAMMA.md](MODALITY_WITHOUT_GAMMA.md);
[ADVERSARIAL_EXAMINATION.md](ADVERSARIAL_EXAMINATION.md) Departure III.)*
...
sign-making creature from the Game altogether? Doesn't the bare ability to *mean*
already make us, in some sense, fellow players?

**The examination — what fell, and what was handed back.** Three independent
critics — a skeptic about all values, a defender of expertise, and a realist about
how science actually works — attacked this, and they converged on the same verdict.
...
> *identity* or *worth*. Ranking people by their worth-as-inquirers is exactly the
> corruption to avoid: it swaps a method-gate (which tracks the truth) for an
> identity-gate (which tracks who's in the club). And we owe every claim its
...
- *Gate the claim, not the agent.*
  ...
  - *Breaking:* "we needn't test that — look who's proposing it." Galileo's
    contemporaries who *would not look through the telescope* refused the claim its
    method-test because of who pressed it.
- *Local incompetence is not universal incompetence.*
  - *Adherence:* the child may not run the reactor (a fair competence-gate on a
    *role*) — and that licenses **nothing** about whether to heed the child who
    shouts that the corridor is on fire.
...
- *Method is the gate that tracks the truth.*
  - *Adherence:* peer review and replication gate by *fidelity to the evidence* —
    answerable to something beyond the people in the room.
  - *Breaking:* a clique that admits only its own and calls the resulting consensus
    "reality."

*(Rigor: [FIDELITY_AND_DEPARTURES.md](FIDELITY_AND_DEPARTURES.md) Corollary;
[ADVERSARIAL_EXAMINATION.md](ADVERSARIAL_EXAMINATION.md) Examinations II and III.)*

---

## What changed, in sum

**In the challenger's positions.** Three of four moved under good arguments —
exactly as intended:
- "Inquiry does not converge" → "convergence is undecidable from inside; we prefer
...
*Companions, in order of increasing technical depth:
[FIELD_GUIDE_AND_DRAGONS.md](FIELD_GUIDE_AND_DRAGONS.md) (a beginner's on-ramp with
worked pitfalls) · this account · [FIDELITY_AND_DEPARTURES.md](FIDELITY_AND_DEPARTURES.md)
(the departures stated precisely) · [LEVEL_ZERO_AND_THE_REGISTERS.md](LEVEL_ZERO_AND_THE_REGISTERS.md)
and [MODALITY_WITHOUT_GAMMA.md](MODALITY_WITHOUT_GAMMA.md) (two departures in full) ·
[ADVERSARIAL_EXAMINATION.md](ADVERSARIAL_EXAMINATION.md) (the prosecutions, verbatim
in spirit). What the project is for, overall: [MANIFEST_AND_MEANING.md](MANIFEST_AND_MEANING.md).*
