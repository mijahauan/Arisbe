...
[MODALITY_WITHOUT_GAMMA.md](MODALITY_WITHOUT_GAMMA.md). Distilled from the
second part of a 2026-06 conversation, archived at
...
2. the **conventions** fixing juxtaposition = conjunction, cut = negation, line =
   identity — the habit (interpretant);
...
contingent proposition is not valid; therefore no theorem carries an unenclosed
contingent graph at level 0. You cannot smuggle it in wrapped — `cut[cut[P]]`
...
[MODALITY_WITHOUT_GAMMA.md](MODALITY_WITHOUT_GAMMA.md), and
