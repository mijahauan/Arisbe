...
This script demonstrates the platform-independent layout system for Existential Graph Rendering Format (EGRF).
It creates a simple Peirce's Existential Graph with proper double-cut implication structure and shows how
the layout constraints enforce Peirce's logical containment rules while giving users freedom to move elements
within their logical containers.
"""
...
# Import the fixed layout constraints implementation
from egrf.v3.layout_constraints import (
