...
class Phase1ValidationSuite:
    ...
    def _test_foundational_builder(self):
        ...
        try:
            ...
            working_egi_id = builder.prepare_sheet_for_construction(
                builder.common_sheet_id
            )
            ...
            construction_id = builder.start_construction(
                "Test Construction", "Validation test construction"
            )
            ...
            assert (
                summary["current_state"]["vertices"] == 1
            ), "Vertex not added correctly"
    ...
    def _test_simple_builder(self):
        ...
        try:
            ...
            self.results.append(
                ValidationResult(
                    ...
                    details={
                        ...
                        "success_rate": (
                            success_count / len(utterances) if utterances else 0
                        ),
            ...
            if success_count == len(built_utterances):
                print(
                    f"   ✅ PASS - {success_count}/{len(utterances)} utterances built correctly"
                )
            else:
                print(
                    f"   ⚠️  PARTIAL - {success_count}/{len(utterances)} utterances successful"
                )
    ...
    def _test_rule_governed_composition(self):
        ...
        try:
            ...
            print(
                f"   ✅ PASS - {len(successful_expressions)}/{len(expressions_to_test)} expressions built"
            )
    ...
    def _test_utterance_test_cases(self):
        ...
        try:
            ...
            print(
                f"   ✅ PASS - {passed_tests}/{len(critical_tests)} critical tests passed"
            )
    ...
    def _test_system_integration(self):
        ...
        try:
            ...
            construction_id = foundational_builder.start_construction(
                "Integration Test", "Test integration between systems"
            )
            ...
            construction_summary = foundational_builder.get_construction_summary(
                construction_id
            )
            ...
            self.results.append(
                ValidationResult(
                    ...
                    details={
                        ...
                        "construction_created": construction_summary["current_state"][
                            "vertices"
                        ]
                        > 0,
        ...
        for result in self.results:
            ...
            if result.error_message:
                ...
                if "success_rate" in result.details:
                    key_details.append(
                        f"Success: {result.details['success_rate']*100:.0f}%"
                    )
                if "expressions_successful" in result.details:
                    key_details.append(
                        f"Expressions: {result.details['expressions_successful']}"
                    )
