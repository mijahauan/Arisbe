...
def demonstrate_multiple_transformations():
    ...
    if result1.success:
        result2 = interface.apply_transformation(TransformationRequest(
    ...
    result3 = interface.apply_transformation(TransformationRequest(
    ...
    result4 = interface.apply_transformation(TransformationRequest(
        source_egif='(Wise "Socrates")',
        rule_name="IT+",
        target_area_description="sheet",
        operation_details={"selected_elements": ["v_0"]},  # Try to iterate first vertex
...
def interactive_transformation_demo():
    ...
    for i, example in enumerate(examples, 1):
        ...
        try:
            if example['rule'] == 'INS':
                result = interface.apply_transformation(TransformationRequest(
