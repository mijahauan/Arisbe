...
class TransformationTestSuite:
    ...
    def _add_ins_tests(self):
        ...
        self.tests.append(TransformationTest(
            test_id="ins_001",
            rule_name="INS",
    ...
    def _add_era_tests(self):
        ...
        self.tests.append(TransformationTest(
            ...
            target_area="sheet",
            operation_details={"selected_elements": ["human_edge"]},  # Will be resolved dynamically
    ...
    def _run_transformation_test(self, test: TransformationTest, start_time: float) -> TestExecutionResult:
        ...
        operation_details = self._resolve_operation_details(source_egif, test.operation_details)
    ...
    def _run_composition_test(self, test: TransformationTest, start_time: float) -> TestExecutionResult:
        ...
        try:
            ...
            # Insert a predicate
            response = self.composition_transformer.insert_in_composition_area('(Test "composition")')
    ...
    def _resolve_operation_details(self, source_egif: str, operation_details: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def run_all_tests(self, categories: Optional[List[str]] = None, 
                     tags: Optional[List[str]] = None) -> List[TestExecutionResult]:
        ...
        if tags:
            tests_to_run = [t for t in tests_to_run if any(tag in (t.tags or []) for tag in tags)]
    ...
    def generate_test_report(self, results: List[TestExecutionResult]) -> Dict[str, Any]:
        ...
        for result in results:
            ...
            if category not in by_category:
                by_category[category] = {"total": 0, "passed": 0, "failed": 0, "errors": 0}
        ...
        failed_tests = [r for r in results if r.result in [TestResult.FAIL, TestResult.ERROR]]
        ...
        return {
            ...
            "execution_times": {
                ...
                "average": sum(r.execution_time for r in results) / len(results) if results else 0,
                "slowest": max(results, key=lambda r: r.execution_time) if results else None
            }
        }
