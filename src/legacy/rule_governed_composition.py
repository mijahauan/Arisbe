...
class RuleGovernedComposer:
    ...
    def __init__(self, validation_level: ValidationLevel = ValidationLevel.STRICT):
        ...
        self.active_compositions: Dict[str, str] = {}  # composition_id -> current_egi_id
    ...
    def create_composition_plan(self, title: str, description: str,
                              pattern: CompositionPattern,
                              composition_steps: List[Dict[str, Any]]) -> str:
        ...
        for i, step in enumerate(plan.composition_steps):
            try:
                ...
                new_egi_id = self.builder.pipeline.apply_transformation(
                    ...
                    logical_justification=step.get("justification", f"Composition step {i+1}")
                )
    ...
    def build_logical_expression(self, expression_type: str, 
        ...
        for i, component in enumerate(components):
            ...
            steps.append({
                ...
                "transformation_data": {
                    ...
                    "target_area": "sheet",
                    "enclosed_elements": frozenset([component.get("id", f"v{i+1}")])
                },
        ...
        steps = [
            ...
            # Negate antecedent
            {
                ...
                "transformation_data": {
                    ...
                    "target_area": "sheet",
                    "enclosed_elements": frozenset([antecedent.get("id", "antecedent")])
                },
    ...
    def _validate_step_preconditions(self, step: Dict[str, Any], 
                                   egi: RelationalGraphWithCuts) -> bool:
    ...
    def _validate_step_postconditions(self, step: Dict[str, Any],
                                    egi: RelationalGraphWithCuts) -> bool:
    ...
    def analyze_composition(self, composition_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "rule_compliance": "strict" if self.validation_level == ValidationLevel.STRICT else "permissive"
        }
