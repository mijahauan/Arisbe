{{ ... }}
from historical_graph_model import HistoricalGraph, HistoricalGraphRepository, CompositionSource
{{ ... }}
...
class SheetOfAssertion:
    ...
    def _record_transformation(self, operation: OperationRequest, result: OperationResult):
    ...
    def export_with_history(self) -> Dict[str, Any]:
        ...
        base_export.update({
            ...
            "active_contexts": {cid: ctx.to_dict() for cid, ctx in self.active_contexts.items()},
