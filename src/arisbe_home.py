...
# Remove legacy imports - now using current development
...
class WorkingRoom(QFrame):
    ...
    def _setup_room_ui(self, title: str, description: str, help_text: str, color: str):
        ...
        help_label.setStyleSheet(
            "color: #666; font-style: italic; background-color: #f9f9f9; padding: 8px; border-radius: 4px;"
        )
...
class ArisbeHomeWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        if house_image_path.exists():
            ...
            scaled_pixmap = house_pixmap.scaled(
        ...
        intro_text.setStyleSheet(
            "color: #495057; font-size: 12px; margin: 20px 0 30px 0;"
        )
    ...
    def _handle_room_selection(self, room_name: str):
        ...
        # Emit signal to parent IntegratedArisbeWindow to handle room navigation
        self.room_requested.emit(room_name, {})
...
class IntegratedArisbeWindow(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Help button
        self.help_btn = QPushButton("📖 Help & Docs")
        ...
        self.help_btn.clicked.connect(self._show_help_documentation)

        # Room indicators
        self.current_room_label = QLabel("Foyer")
        self.current_room_label.setStyleSheet(
            "color: white; font-size: 14px; font-weight: bold; font-family: Georgia;"
        )
    ...
    def _handle_library_to_workshop_handoff(self, payload: dict):
        ...
        # This functionality is now handled directly by the home widget
        pass

    def _show_help_documentation(self):
        ...
        help_dialog.setWindowTitle("Arisbe Help & Documentation")
        ...
        # Header
        header_label = QLabel("📖 Arisbe Help & Documentation")
        header_font = QFont("Georgia", 18)
        header_font.setBold(True)
        header_label.setFont(header_font)
        header_label.setAlignment(Qt.AlignCenter)
        header_label.setStyleSheet("color: #8B4513; margin: 10px 0;")
        ...
        getting_started.setHtml(
            """
        <h3>Welcome to Arisbe</h3>
        <p>Arisbe is your intellectual home for Existential Graph inquiry, named after Charles Sanders Peirce's residence in northeast New Jersey.</p>
        ...
        # Organon Help tab
        organon_help = QTextEdit()
        organon_help.setReadOnly(True)
        organon_help.setHtml(
            """
        <h3>📚 Organon - Your Library</h3>
        <p>The Organon serves as your personal library and browser for existential graph collections.</p>
        ...
        tab_widget.addTab(organon_help, "Organon Guide")

        # Ergasterion Help tab
        ergasterion_help = QTextEdit()
        ergasterion_help.setReadOnly(True)
        ergasterion_help.setHtml(
            """
        <h3>🔨 Ergasterion - Your Workshop</h3>
        <p>The Ergasterion is your creative workshop for hands-on diagram work with full constraint validation.</p>
        
        <h4>Features</h4>
        <ul>
        <li><b>Diagram Editor</b>: Interactive canvas for creating and editing existential graphs</li>
        <li><b>Constraint Validation</b>: Real-time checking of EG formalism compliance</li>
        <li><b>Transformation Rules</b>: Guided application of Dau-compliant transformation rules</li>
        <li><b>Practice Modes</b>: Warmup and Practice modes for learning</li>
        </ul>
        
        <h4>Transformation Wizards</h4>
        <ul>
        <li><b>INS (Insertion)</b>: Insert cuts with proper position selection</li>
        <li><b>DER (Deiteration)</b>: Remove repeated subgraphs</li>
        <li><b>DC (Double Cut)</b>: Apply double cut elimination rules</li>
        </ul>
        """
        )
        tab_widget.addTab(ergasterion_help, "Ergasterion Guide")

        # Documentation tab
        docs_help = QTextEdit()
        docs_help.setReadOnly(True)
        docs_help.setHtml(
            """
        ...
        <ul>
        <li><b>README.md</b>: Project overview and setup instructions</li>
        <li><b>Plan.md</b>: Development roadmap and architecture</li>
        <li><b>docs/</b> folder: Detailed technical documentation</li>
        <li><b>examples/</b>: Sample graphs and usage examples</li>
        </ul>
        
        <h4>Key References</h4>
        <ul>
        <li><b>Dau's Formalism</b>: Mathematical foundation for existential graphs</li>
        <li><b>Peirce's Original Work</b>: Historical context and philosophical background</li>
        <li><b>Common Logic</b>: Standards and interoperability</li>
        </ul>
        ...
        tab_widget.addTab(docs_help, "Documentation")
