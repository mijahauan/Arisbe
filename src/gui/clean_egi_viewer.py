...
class CleanEGIViewer(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.view.setDragMode(QGraphicsView.DragMode.RubberBandDrag if not self.read_only 
    ...
    def load_egi(self, egi: RelationalGraphWithCuts) -> None:
        ...
        try:
            ...
            print(f"[CleanEGIViewer] Loaded EGI with {vertex_count} vertices, "
        ...
        if not self.read_only:
            ...
            if element_info:
                ...
                if event.button() == Qt.MouseButton.LeftButton:
                    self.element_selected.emit(element_id, element_type)
                elif event.button() == Qt.MouseButton.LeftButton and event.type() == event.Type.MouseButtonDblClick:
