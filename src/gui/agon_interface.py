...
class AgonInterface(QMainWindow):
    ...
    def _create_hypothesis_testing_tab(self) -> QWidget:
        ...
        self.results_table.setHorizontalHeaderLabels(
            ["Hypothesis", "Test Type", "Result", "Confidence"]
        )
    ...
    def _new_endoporeutic_game(self):
        ...
        self.game_view.fitInView(
            self.game_scene.itemsBoundingRect(), Qt.KeepAspectRatio
        )
    ...
    def _add_hypothesis(self):
        ...
        hypothesis_egi = RelationalGraphWithCuts(
            ...
            Cut=frozenset(),
            area=frozendict(
                {f"hypothesis_{len(self.current_hypotheses) + 1}": frozenset()}
            ),
            rel=frozendict(),
        )
