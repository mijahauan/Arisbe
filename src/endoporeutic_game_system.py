...
class EndoporeuticGameEngine:
    ...
    def create_domain_model(self, domain_id: str, name: str, description: str, 
                          domain_egif: str, axioms: List[str] = None) -> DomainModel:
    ...
    def start_game(self, game_id: str, domain_id: str, proposer_id: str, 
                   skeptic_id: str, umpire_id: Optional[str] = None) -> 'EndoporeuticGame':
    ...
    def list_domain_models(self) -> List[Tuple[str, str, str]]:
        ...
        return [(dm.domain_id, dm.name, dm.description) 
...
class EndoporeuticGame:
    ...
    def _initialize_game_context(self):
        ...
        composition_context = StandardCompositionContexts.create_domain_model_context(
            self.domain_model.domain_egif,
            f"{self.game_id}_context"
        )
    ...
    def declare_victory(self, player: PlayerRole, victory_reason: str) -> bool:
        ...
        self._record_move(
            ...
            content={
                ...
                "final_state": generate_egif(self.proof_context.current_state) if self.proof_context else None
            },
    ...
    def _record_move(self, player: PlayerRole, move_type: str, content: Dict[str, Any],
                    description: str, egif_before: Optional[str] = None,
                    egif_after: Optional[str] = None, transformation_used: Optional[str] = None,
                    is_valid: bool = True, validation_notes: str = "") -> GameMove:
    ...
    def get_game_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "proof_steps": len(self.proof_context.proof_steps) if self.proof_context else 0,
            "current_egif": generate_egif(self.proof_context.current_state) if self.proof_context else None,
