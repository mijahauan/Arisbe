...
from enhanced_transformation_history import EnhancedEGITransformationHistory, ProofExportFormat, CollaborationMetadata
...
from egi_transformation_history import LogicalProvenance, TransformationStatus, StateSnapshot, TransformationStep, HistoryBranch, HistoryBranchType
...
class HistoryPersistenceManager:
    ...
    def save_history_json(self, 
                         ...
                         include_compressed_states: bool = False) -> Path:
        ...
        history_data = self._serialize_history_to_dict(history, include_compressed_states)
        
        # Write JSON with pretty formatting
        with open(filepath, 'w', encoding='utf-8') as f:
            json.dump(history_data, f, indent=2, ensure_ascii=False, default=self._json_serializer)
        
        return filepath
    
    def load_history_json(self, filepath: Union[str, Path]) -> EnhancedEGITransformationHistory:
    ...
    def save_history_yaml(self,
                         history: EnhancedEGITransformationHistory,
                         filename: Optional[str] = None,
                         include_annotations: bool = True) -> Path:
        ...
        history_data = self._serialize_history_to_dict(history, include_compressed_states=False)
    ...
    def load_history_yaml(self, filepath: Union[str, Path]) -> EnhancedEGITransformationHistory:
    ...
    def save_history_compressed(self,
                               history: EnhancedEGITransformationHistory,
        ...
        history_data = self._serialize_history_to_dict(history, include_compressed_states=True)
        json_bytes = json.dumps(history_data, default=self._json_serializer).encode('utf-8')
    ...
    def load_history_compressed(self, filepath: Union[str, Path]) -> EnhancedEGITransformationHistory:
    ...
    def save_incremental_checkpoint(self,
                                   history: EnhancedEGITransformationHistory,
        ...
        for state_id, state in history.states.items():
            if state.step_number >= recent_threshold:
                checkpoint_data["recent_states"][state_id] = self._serialize_state(state)
        ...
        for step_id, step in history.transformations.items():
            ...
            if from_step >= recent_threshold:
                checkpoint_data["recent_transformations"][step_id] = self._serialize_transformation(step)
    ...
    def export_proof_sequence(self,
                             history: EnhancedEGITransformationHistory,
                             from_state_id: str,
                             to_state_id: str,
                             export_format: str = "yaml") -> Path:
        ...
        proof_data = {
            ...
            "natural_language_narrative": history.get_natural_language_narrative(from_state_id, to_state_id),
    ...
    def _serialize_history_to_dict(self, 
                                  history: EnhancedEGITransformationHistory,
                                  include_compressed_states: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            } if include_compressed_states else {}
        }
    ...
    def _serialize_transformation(self, step: TransformationStep) -> Dict[str, Any]:
        ...
        return {
            ...
            "logical_provenance": self._serialize_provenance(step.logical_provenance) if step.logical_provenance else None,
    ...
    def _serialize_domain_model(self, domain_manager: DomainModelManager) -> Dict[str, Any]:
    ...
    def _serialize_result(self, result) -> Dict[str, Any]:
        ...
        return {
            ...
            "result_egi_data": to_dict(result.result_egi) if result.result_egi else None
        }
    
    def _deserialize_history_from_dict(self, data: Dict[str, Any]) -> EnhancedEGITransformationHistory:
        """Deserialize history from dictionary."""
        from enhanced_transformation_history import EnhancedEGITransformationHistory, CollaborationMetadata
        from egi_transformation_history import LogicalProvenance, TransformationStatus, StateSnapshot, TransformationStep, HistoryBranch, HistoryBranchType
        ...
        initial_state_id = min(states_data.keys(), key=lambda sid: states_data[sid]["step_number"])
        ...
        history.created_timestamp = datetime.fromisoformat(metadata["created_timestamp"])
        ...
        if "collaboration_metadata" in data:
            ...
            history.collaboration_metadata = CollaborationMetadata(
                ...
                conflict_resolution_strategy=collab_data["conflict_resolution_strategy"]
            )
    ...
    def _deserialize_transformation(self, step_data: Dict[str, Any]) -> TransformationStep:
    ...
    def _deserialize_context(self, context_data: Dict[str, Any]) -> TransformationContext:
        ...
        return TransformationContext(
            ...
            selected_subgraph=frozenset(ElementID(elem) for elem in context_data["selected_subgraph"]),
